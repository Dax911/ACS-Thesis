...
\begin{document}
\title{Creating a Content First Fantasy Sports Platform\\
            A Narrowed Scoped View through Speedrunning}
\author{Hayden A. Porter-Aylor}
\dept{Applied Computer Science}
\principaladviser{A Professor name 1}
\firstreader{B Professor name 2}
\secondreader{C Professor name 3}
...
\bibliographystyle{apalike}  % can change to fit your field e.g. pnas2009
